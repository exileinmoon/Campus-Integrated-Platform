...
public class ChatSessions implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLast_message_id() == null ? other.getLast_message_id() == null : this.getLast_message_id().equals(other.getLast_message_id()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLast_message_id() == null) ? 0 : getLast_message_id().hashCode());
